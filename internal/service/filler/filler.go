...
func (f *Filler) NewMedia(_ context.Context, _ int64, _ models.MediaConfig) (int64, error) {
	return 0, nil
}
...
func (f *Filler) DeleteMedia(_ context.Context, _ int64, _ models.MediaConfig) error {
	return nil
}
